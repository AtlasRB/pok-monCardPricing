...
<html lang="en">
    ...
    <body style="color: white; background-color: black;">
        <div class="container mt-5">
            ...
            <h3>Add New Item</h3>
            @php
                $cardTypes = ['Gen 1 - Not selling', 'Gen 1 - Double', 'Gen 2 - Not selling', 'Gen 2 - Double', 'Gen 3 - Not selling', 'Gen 3 - Double', 'Gen 4 - Not selling', 'Gen 4 - Double', 'Gen 5 - Not selling', 'Gen 5 - Double', 'Items - Not selling', 'Items - Double'];
            @endphp
